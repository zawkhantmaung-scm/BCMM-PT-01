      ...
      <div>
        ...
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            password_confirmation: Yup.string().required("The confirmation password is required.")
              .max(191, "The confirmation password must not be greater than 191 characters.")
              .oneOf([Yup.ref('password'), null], 'The confirmation password does not match.')
          })}
          onSubmit={values => {
